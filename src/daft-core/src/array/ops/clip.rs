use crate::datatypes::{
    DataArray, DataType, Float32Array, Float64Array, Float64Type, Int128Array, Int16Array,
...
macro_rules! impl_clip_for_numeric_array {
    ...
    ($array_type:ident, $type:ty,$variant:ident, $convert:ident, int) => {
        impl $array_type {
            pub fn clip<T>(&self, lower: Option<T>, upper: Option<T>) -> DaftResult<NumericArray>
            where
                T: Into<f64> + Copy,
                ...
                if float_bounds {
                    ...
                    let result = float_array
                        ...
                        .apply(|v| {
                            ...
                            v_as_f64.clamp(float_lower as f64, float_upper as f64)
                        })?;
...
impl_clip_for_numeric_array!(Int8Array, i8, Int8, F64, int);
impl_clip_for_numeric_array!(Int16Array, i16, Int16, F64, int);
impl_clip_for_numeric_array!(Int32Array, i32, Int32, F64, int);
impl_clip_for_numeric_array!(Int64Array, i64, Int64, F64, int);
impl_clip_for_numeric_array!(Int128Array, i128, Int128, F64, int);
impl_clip_for_numeric_array!(UInt8Array, u8, UInt8, F64, int);
impl_clip_for_numeric_array!(UInt16Array, u16, UInt16, F64, int);
impl_clip_for_numeric_array!(UInt32Array, u32, UInt32, F64, int);
impl_clip_for_numeric_array!(UInt64Array, u64, UInt64, F64, int);
